...
export class OpenAiProviderPlaceholder implements LlmProviderPort {
  ...
  public async complete(_request: LlmCompletionRequest): Promise<LlmCompletionResponse> {
    throw new AppError("OpenAI provider is not implemented yet", 501, "LLM_PROVIDER_NOT_IMPLEMENTED");
  }
}
